package com.hopscotchtrading.huobi_java_sdk.service.huobi.signature;
...
public class UrlParamsBuilder {
    ...
    class ParamsMap {
        ...
        void put(String name, String value) {
            ...
            if (name == null || "".equals(name)) {
                throw new SDKException(SDKException.RUNTIME_ERROR, "[URL] Key can not be null");
            }
    ...
    private static String urlEncode(String s) {
        try {
            ...
            throw new SDKException(SDKException.RUNTIME_ERROR, "[URL] UTF-8 encoding not supported!");
        }
    }
}
