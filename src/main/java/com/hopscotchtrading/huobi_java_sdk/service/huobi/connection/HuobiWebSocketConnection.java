...
public class HuobiWebSocketConnection extends WebSocketListener implements WebSocketConnection {
    ...
    public static HuobiWebSocketConnection createAssetV2Connection(Options options, List<String> commandList,
            HuobiModelParser parser, ResponseCallback callback, Boolean autoClose) {
    ...
    private void sendAuthV2_1() {
        ...
        try {
            as.createSignature(options.getApiKey(), options.getSecretKey(), "GET", this.getHost(),
                    HUOBI_TRADING_WEBSOCKET_V2_PATH, builder);
        } catch (Exception e) {
    ...
    private void sendAuthV2() {
        ...
        try {
            as.createSignature(options.getApiKey(), options.getSecretKey(), "GET", this.getHost(),
                    HUOBI_TRADING_WEBSOCKET_PATH, builder);
        } catch (Exception e) {
