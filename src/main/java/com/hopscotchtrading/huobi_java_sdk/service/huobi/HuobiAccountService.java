...
import com.hopscotchtrading.huobi_java_sdk.service.huobi.parser.account.AccountAssetValuationResultParser;
import com.hopscotchtrading.huobi_java_sdk.service.huobi.parser.account.AccountBalanceParser;
import com.hopscotchtrading.huobi_java_sdk.service.huobi.parser.account.AccountFuturesTransferResultParser;
import com.hopscotchtrading.huobi_java_sdk.service.huobi.parser.account.AccountHistoryParser;
import com.hopscotchtrading.huobi_java_sdk.service.huobi.parser.account.AccountLedgerParser;
import com.hopscotchtrading.huobi_java_sdk.service.huobi.parser.account.AccountParser;
import com.hopscotchtrading.huobi_java_sdk.service.huobi.parser.account.AccountTransferResultParser;
import com.hopscotchtrading.huobi_java_sdk.service.huobi.parser.account.AccountUpdateEventParser;
import com.hopscotchtrading.huobi_java_sdk.service.huobi.parser.account.PointParser;
import com.hopscotchtrading.huobi_java_sdk.service.huobi.parser.account.PointTransferResultParser;
...
public class HuobiAccountService implements AccountClient {
    ...
    public List<AccountHistory> getAccountHistory(AccountHistoryRequest request) {
        ...
        UrlParamsBuilder builder = UrlParamsBuilder.build().putToUrl("account-id", request.getAccountId())
                .putToUrl("currency", request.getCurrency()).putToUrl("transact-types", request.getTypesString())
    ...
    public AccountLedgerResult getAccountLedger(AccountLedgerRequest request) {
        ...
        InputChecker.checker().shouldNotNull(request.getAccountId(), "accountId");

        UrlParamsBuilder builder = UrlParamsBuilder.build().putToUrl("accountId", request.getAccountId())
                .putToUrl("currency", request.getCurrency()).putToUrl("transactTypes", request.getTypesString())
                .putToUrl("startTime", request.getStartTime()).putToUrl("endTime", request.getEndTime())
                .putToUrl("sort", request.getSort() == null ? null : request.getSort().getSort())
        ...
        JSONArray jsonArray = jsonObject.getJSONArray("data");
        return AccountLedgerResult.builder().nextId(nextId).ledgerList(new AccountLedgerParser().parseArray(jsonArray))
                .build();
    }

    public AccountTransferResult accountTransfer(AccountTransferRequest request) {

        InputChecker.checker().shouldNotNull(request.getFromUser(), "from-user")
                .shouldNotNull(request.getFromAccount(), "from-account")
                .shouldNotNull(request.getFromAccountType(), "from-account-type")
                .shouldNotNull(request.getToUser(), "to-user").shouldNotNull(request.getToAccount(), "to-account")
        ...
        UrlParamsBuilder builder = UrlParamsBuilder.build().putToPost("from-user", request.getFromUser())
                .putToPost("from-account", request.getFromAccount())
                .putToPost("from-account-type", request.getFromAccountType().getAccountType())
                .putToPost("to-user", request.getToUser()).putToPost("to-account", request.getToAccount())
                .putToPost("to-account-type", request.getToAccountType().getAccountType())
                .putToPost("currency", request.getCurrency()).putToPost("amount", request.getAmount());
    ...
    public AccountFuturesTransferResult accountFuturesTransfer(AccountFuturesTransferRequest request) {
        InputChecker.checker().shouldNotNull(request.getCurrency(), "currency")
        ...
        UrlParamsBuilder builder = UrlParamsBuilder.build().putToPost("currency", request.getCurrency())
                .putToPost("amount", request.getAmount()).putToPost("type", request.getType().getType());
    ...
    public PointTransferResult pointTransfer(PointTransferRequest request) {
        UrlParamsBuilder builder = UrlParamsBuilder.build().putToPost("fromUid", request.getFromUid())
                .putToPost("toUid", request.getToUid()).putToPost("groupId", request.getGroupId())
    ...
    public AccountAssetValuationResult accountAssetValuation(AccountAssetValuationRequest request) {
        UrlParamsBuilder builder = UrlParamsBuilder.build().putToUrl("accountType", request.getAccountType().getCode())
                .putToUrl("valuationCurrency", request.getValuationCurrency()).putToUrl("subUid", request.getSubUid());
    ...
    public void subAccountsUpdate(SubAccountUpdateRequest request, ResponseCallback<AccountUpdateEvent> callback) {
        InputChecker.checker().shouldNotNull(request.getAccountUpdateMode(), "account update model");
        ...
        HuobiWebSocketConnection.createAssetV2Connection(options, commandList, new AccountUpdateEventParser(), callback,
                false);
    }
