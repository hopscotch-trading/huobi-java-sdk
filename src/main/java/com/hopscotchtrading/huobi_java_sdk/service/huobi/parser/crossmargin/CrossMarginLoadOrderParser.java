package com.hopscotchtrading.huobi_java_sdk.service.huobi.parser.crossmargin;
...
public class CrossMarginLoadOrderParser implements HuobiModelParser<CrossMarginLoadOrder> {
    ...
    public CrossMarginLoadOrder parse(JSONObject json) {
        return CrossMarginLoadOrder.builder().id(json.getLong("id")).userId(json.getLong("user-id"))
                .accountId(json.getLong("account-id")).currency(json.getString("currency"))
                ...
                .interestAmount(json.getBigDecimal("interest-amount")).filledPoints(json.getBigDecimal("filled-points"))
                .filledHt(json.getBigDecimal("filled-ht")).state(json.getString("state"))
                .accruedAt(json.getLong("accrued-at")).createdAt(json.getLong("created-at")).build();
    }
