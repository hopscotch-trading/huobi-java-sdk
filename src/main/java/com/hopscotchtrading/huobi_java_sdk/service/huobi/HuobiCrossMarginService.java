...
public class HuobiCrossMarginService implements CrossMarginClient {
    ...
    public Long transfer(CrossMarginTransferRequest request) {
        ...
        InputChecker.checker().shouldNotNull(request.getDirection(), "direction").checkCurrency(request.getCurrency())
    ...
    public Long applyLoan(CrossMarginApplyLoanRequest request) {
        ...
        InputChecker.checker().checkCurrency(request.getCurrency()).shouldNotNull(request.getAmount(), "amount");
