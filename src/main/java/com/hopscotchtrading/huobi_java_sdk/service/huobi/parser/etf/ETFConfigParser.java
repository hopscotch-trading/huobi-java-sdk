...
import com.hopscotchtrading.huobi_java_sdk.constant.enums.EtfStatusEnum;
...
public class ETFConfigParser implements HuobiModelParser<ETFConfig> {
    ...
    public ETFConfig parse(JSONObject json) {
        return ETFConfig.builder().purchaseMinAmount(json.getInteger("purchase_min_amount"))
                ...
                .unitPriceList(new ETFUnitPriceParser().parseArray(json.getJSONArray("unit_price"))).build();
    }
