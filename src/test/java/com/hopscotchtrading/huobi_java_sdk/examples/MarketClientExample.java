...
public class MarketClientExample {
    ...
    public static void main(String[] args) {
        ...
        List<Candlestick> list = marketClient.getCandlestick(
                CandlestickRequest.builder().symbol(symbol).interval(CandlestickIntervalEnum.MIN15).size(10).build());
        ...
        List<MarketTrade> marketTradeList = marketClient
                .getMarketTrade(MarketTradeRequest.builder().symbol(symbol).build());
        ...
        List<MarketTrade> marketHistoryTradeList = marketClient
                .getMarketHistoryTrade(MarketHistoryTradeRequest.builder().symbol(symbol).build());
        ...
        marketClient.subCandlestick(
                SubCandlestickRequest.builder().symbol(symbol).interval(CandlestickIntervalEnum.MIN15).build(),
                (candlestick) -> {
        ...
        marketClient.reqCandlestick(
                ReqCandlestickRequest.builder().symbol(symbol).interval(CandlestickIntervalEnum.MIN15).build(),
                candlestickReq -> {
        ...
        marketClient.reqMarketDepth(ReqMarketDepthRequest.builder().symbol(symbol).step(DepthStepEnum.STEP0).build(),
                marketDepthReq -> {

                    System.out.println(marketDepthReq.toString());
                });

        marketClient.reqMarketTrade(ReqMarketTradeRequest.builder().symbol(symbol).build(), marketTradeReq -> {

            System.out.println(marketTradeReq.toString());
        });

        marketClient.reqMarketDetail(ReqMarketDetailRequest.builder().symbol(symbol).build(), marketDetailReq -> {

            System.out.println(marketDetailReq.toString());
        });

        marketClient.subMbpRefreshUpdate(
                SubMbpRefreshUpdateRequest.builder().symbols(symbol).levels(DepthLevels.LEVEL_5).build(), event -> {
