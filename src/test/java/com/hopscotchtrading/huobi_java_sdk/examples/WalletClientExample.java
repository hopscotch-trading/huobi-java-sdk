...
public class WalletClientExample {
    ...
    public static void main(String[] args) {
        ...
        List<DepositAddress> addressList = walletService
                .getDepositAddress(DepositAddressRequest.builder().currency("usdt").build());
        addressList.forEach(depositAddress -> {
            System.out.println(depositAddress.toString());
        });

        WithdrawQuota withdrawQuota = walletService
                .getWithdrawQuota(WithdrawQuotaRequest.builder().currency("usdt").build());
        ...
        long withdrawId = walletService
                .createWithdraw(CreateWithdrawRequest.builder().address(withdrawAddress).addrTag(withdrawAddressTag)
                        .currency("eos").amount(new BigDecimal("1")).fee(new BigDecimal("0.1")).build());
        ...
        List<DepositWithdraw> depositWithdrawList = walletService
                .getDepositWithdraw(DepositWithdrawRequest.builder().type(DepositWithdrawTypeEnum.WITHDRAW).build());
        ...
        WithdrawAddressResult withdrawAddressResult = walletService
                .getWithdrawAddress(WithdrawAddressRequest.builder().currency("usdt").limit(1).build());
